...
function buildCustomerPayload(record = {}, owner = null, business = null) {
  ...
  return {
    ...
    phone: record.phone || "",
    email: record.email || "",
    businessName: owner?.businessName || record.businessName || "",
    businessType: owner?.businessType || business?.type || record.businessType || "",
    industry: business?.industry || owner?.industry || record.industry || "",
    businessLogo: business?.logo || owner?.businessLogo || record.businessLogo || "",
